...
@Component({
  selector: 'app-show-file-stats',
  templateUrl: './show-file-stats.component.html',
  styleUrls: ['./show-file-stats.component.css']
})
export class ShowFileStatsComponent implements OnInit {
  ...
  sendIndexFolderToBackEnd(): void
  {
    ...
    let url :string = 'http://localhost:8080/getFileStats';
