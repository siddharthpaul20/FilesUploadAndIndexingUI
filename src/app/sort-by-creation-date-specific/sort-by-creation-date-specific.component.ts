...
@Component({
  selector: 'app-sort-by-creation-date-specific',
  templateUrl: './sort-by-creation-date-specific.component.html',
  styleUrls: ['./sort-by-creation-date-specific.component.css']
})
export class SortByCreationDateSpecificComponent implements OnInit {
  ...
  sendIndexFolderToBackEnd(): void
  {
    ...
    let url :string = 'http://localhost:8080/getSortByCreationDateSpecific';
