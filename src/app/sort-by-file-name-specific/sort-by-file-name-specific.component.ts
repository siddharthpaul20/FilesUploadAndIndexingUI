...
@Component({
  selector: 'app-sort-by-file-name-specific',
  templateUrl: './sort-by-file-name-specific.component.html',
  styleUrls: ['./sort-by-file-name-specific.component.css']
})
export class SortByFileNameSpecificComponent implements OnInit {
  ...
  sendIndexFolderToBackEnd(): void
  {
    ...
    let url :string = 'http://localhost:8080/getSortByFileNameSpecific';
